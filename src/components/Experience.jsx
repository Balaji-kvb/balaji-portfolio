...
const experiences = [
    {
        ...
        description: 'Developed a production-ready slot booking platform to digitize manual scheduling operations. Implemented an interval-overlap detection algorithm to prevent booking conflicts. Built an admin dashboard for managing bookings.',
    ...
    },
    {
        ...
        description: 'Built a corporate web application using React and Next.js. Integrated a B2B inquiry and lead management system with WhatsApp support. Improved UI responsiveness across devices.',
    ...
    },
    {
        ...
        description: 'Worked on real-world data visualization projects using Power BI, Tableau, and Python. Transformed raw data into actionable insights and interactive dashboards.',
        tech: ['Power BI', 'Tableau', 'Python'],
        color: 'from-blue-400 to-cyan-400',
    },
    {
        role: 'AI Intern (IBM SkillsBuild)',
        company: 'Edunet Foundation',
        duration: 'Jun 2025 – Jul 2025',
        description: 'Built machine learning models for classification and regression tasks using Python. Hands-on work with Pandas, NumPy, and Scikit-learn.',
